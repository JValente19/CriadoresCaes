    ...
    public partial class DadosDasTabelas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "CriadoresCaes",
                newName: "IX_CriadoresCaes_CaoFK");
            ...
            migrationBuilder.InsertData(
                table: "Criadores",
                columns: new[] { "Id", "CodigoPostal", "Email", "Morada", "Nome", "NomeComercial", "Telemovel" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Caes",
                columns: new[] { "Id", "LOP", "Nascimento", "Nome", "RacaFK", "Sexo" },
                values: new object[,]
                {
                    { 1, "LOP446793", new DateTime(2019, 4, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "Aguia da Quinta do Conde", 1, "F" },
                    { 2, "LOP446795", new DateTime(2019, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Aileen da Quinta do Lordy", 1, "F" },
                    { 5, "LOP446807", new DateTime(2012, 8, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Alabaster da Casa do Sobreiral", 2, "F" },
                    { 7, "LOP446811", new DateTime(2010, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gardenia da Tapada de Cima", 3, "F" },
                    { 10, "LOP446814", new DateTime(2017, 3, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Garfunkle da Quinta do Lordy", 4, "F" },
                    { 3, "LOP446801", new DateTime(2011, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Aladim do Canto do Bairro Pimenta", 5, "F" },
                    { 4, "LOP446804", new DateTime(2008, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "Albert do Canto do Bairro Pimenta", 5, "F" },
                    { 6, "LOP446809", new DateTime(2010, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gannett do Quintal de Cima", 6, "F" },
                    { 8, "LOP446799", new DateTime(2013, 4, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Forte da Flecha do Indio", 7, "F" },
                    { 9, "LOP446812", new DateTime(2011, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Garbo da Flecha do Indio", 7, "M" },
                    { 11, "LOP446816", new DateTime(2018, 1, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Garnet do Quintal de Cima", 8, "M" }
                });

            migrationBuilder.InsertData(
                table: "CriadoresCaes",
                columns: new[] { "Id", "CaoFK", "CriadoresFK", "DataCompra" },
                values: new object[,]
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "CriadoresCaes",
                newName: "IX_CriadoresCaes_CaesFK");

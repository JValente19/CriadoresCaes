...
namespace CriadoresCaes.Controllers
{
    public class CriadoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,NomeComercial,Morada,CodigoPostal,Telemovel,Email")] Criadores criadores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,NomeComercial,Morada,CodigoPostal,Telemovel,Email")] Criadores criadores)
        {
            if (id != criadores.Id)
            {
                return NotFound();
